...
<div class="topo-pagina">
    ...
    <p><a href="index.php" title="Sobre a Empresa">Inicio>></a> Empresa</p>
</div>
...
<!--INICIO ITEM COMO FUNCIONA O SITE -->
<div class="box">
    <img src="msflix-1.gif" alt="">
    <h3>Escolha Sua Pizza</h3>
</div>
<!--FIM ITEM COMO FUNCIONA O SITE -->

<!--INICIO ITEM COMO FUNCIONA O SITE -->
<div class="box">
    <img src="msflix-2.gif" alt="">
...
<section class="empresa">
    <div class="row">
        ...
        <div class="content">
            <h3> A Pizzaria BP: <span>O Sabor Que Combina</span> Com Sua Diversão</h3>
            <p>
Se Você É Um Amante De Pizza E De Entretenimento, A Pizzaria BP É O Lugar Perfeito Para Satisfazer Seus Desejos Gastronômicos Enquanto Desfruta De Uma Experiência Única. Localizada em CIANORTE-PR, A BP Se Destaca Como Um Ponto De Encontro Popular Para Aqueles Que Buscam Uma Combinação Perfeita De Sabor E Diversão.
            </p>
            <p>
O Cardápio Da Pizzaria BP Oferece Uma Ampla Variedade De Opções De Pizza, Desde As Tradicionais Margheritas Até Criações Inovadoras Que Deixarão Seu Paladar Encantado. Se Você É Fã De Queijo, Peperoni, Cogumelos Ou Uma Combinação De Ingredientes Especiais, A BP Tem A Pizza Perfeita Para Você. 
            </p>
...
<section class="galeria-fotos">
    <div class="galeria-container">
     ...
     <!--INCIO DO ITEM GALERIA-->
    <a href="galeria1.jpg" class="box">
